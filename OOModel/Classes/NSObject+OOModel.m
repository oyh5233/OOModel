...
static void oo_set_value_for_property_apply(const void *_value, void *_context){
    ...
    if (jsonKeyPathArray.count<2) {
        value=jsonDictionary[jsonKeyPathString];
    }else{
        NSInteger count=[jsonKeyPathArray count];
        NSInteger i=0;
        for(;i<count;i++){
            id nodeValue=value[jsonKeyPathArray[i]];
            if (nodeValue) {
                value=nodeValue;
            }else{
                break;
...
static void oo_get_value_for_property_apply(const void *_value, void * _context){
    ...
    if (jsonKeyPathArray.count<2) {
        parent[jsonKeyPathString]=value;
    }else{
        NSInteger count=jsonKeyPathArray.count;
        int i=0;
        for(;i<count-1;i++){
        ...
        parent[jsonKeyPathArray[i]]=value;
    }
}
...
static void oo_set_value_for_property_apply_db(const void *_value, void *_context){
    ...
    __unsafe_unretained id model=(__bridge id)context->model;
    __unsafe_unretained OOPropertyInfo *propertyInfo=(__bridge id)_value;
    id value=dbDictionary[propertyInfo.propertyKey];
    if (!value) {
        return;
    }
    if (propertyInfo.propertyType&OOPropertyTypeReadonly) {
...
+ (id)_oo_uniqueValueInJsonDictionary:(NSDictionary*)jsonDictionary classInfo:(OOClassInfo*)classInfo{
    ...
    if (uniqueKey) {
        ...
        if (jsonKeyPath) {
            uniqueValue=jsonDictionary[jsonKeyPath];
        }
    }
    if (!uniqueValue) {
        return uniqueValue;
    ...
    if (db) {
        [db syncInDb:^(OODb *db) {
            [db executeQuery:classInfo.uniqueSelectSql context:(__bridge void *)self stmtBlock:^(void *context, sqlite3_stmt *stmt, int index) {
                ...
                switch (propertyInfo.dbColumnType) {
                    case OODbColumnTypeInteger:
                        sqlite3_bind_int64(stmt, index+1, [uniqueValue longLongValue]);
                        break;
                    case OODbColumnTypeReal:
                        sqlite3_bind_double(stmt, index+1, [uniqueValue doubleValue]);
                        break;
                    case OODbColumnTypeText:
                        sqlite3_bind_text(stmt, index+1, [[uniqueValue description] UTF8String], -1, SQLITE_STATIC);
                        break;
                        
                    case OODbColumnTypeBlob:
                        sqlite3_bind_blob(stmt, index, [uniqueValue bytes], (int)[uniqueValue length], SQLITE_STATIC);
                        break;
                    default:
                        NSCParameterAssert(0);
                        break;
                }
            } resultBlock:^(void *context, sqlite3_stmt *stmt) {
                ...
                for (int index=0;index<count;index++){
                    OOPropertyInfo *propertyInfo=classInfo.propertyInfosByPropertyKeys[[NSString stringWithUTF8String:sqlite3_column_name(stmt, index)]];
                    ...
                    switch (type) {
                        case SQLITE_INTEGER:
                        {
                            ...
                            if (propertyInfo.dbValueTransformer) {
                                ((void (*)(id, SEL, id))(void *) objc_msgSend)(model, propertyInfo.setter,[propertyInfo.dbValueTransformer transformedValue:@(value)]);
                                break;
                            }
                            switch (propertyInfo.encodingType) {
                                case OOEncodingTypeBool:
                                ...
                                case OOEncodingTypeUInt32:
                                    ...
                                    break;
                                case OOEncodingTypeInt64:
                                    ((void (*)(id, SEL, long long))(void *) objc_msgSend)(model, propertyInfo.setter,(long long)value);
                                    break;
                                case OOEncodingTypeUInt64:
                                ...
                                case OOEncodingTypeFloat:
                                    ...
                                    break;
                                case OOEncodingTypeDouble:
                                    ((void (*)(id, SEL, double))(void *) objc_msgSend)(model, propertyInfo.setter,(double)value);
                                    break;
                                case OOEncodingTypeNSString:
                                    ((void (*)(id, SEL, NSString *))(void *) objc_msgSend)(model, propertyInfo.setter,[NSString stringWithFormat:@"%@",@(value)]);
                                    break;
                                case OOEncodingTypeNSDate:
                                    ((void (*)(id, SEL, NSDate *))(void *) objc_msgSend)(model, propertyInfo.setter,[NSDate dateWithTimeIntervalSince1970:(NSTimeInterval)value]);
                                    break;
                                case OOEncodingTypeNSNumber:
                                    ((void (*)(id, SEL, NSNumber*))(void *) objc_msgSend)(model, propertyInfo.setter,@(value));
                                    break;
                                default:
                                    NSLog(@"unexpected db value.class:%@,property:%@",NSStringFromClass(propertyInfo.ownClassInfo.cls),propertyInfo.propertyKey);
                                    break;
                            }
                        }
                            break;
                        ...
                        case SQLITE_TEXT:
                        {
                            NSString *value=[NSString stringWithUTF8String:(const char *)sqlite3_column_text(stmt, index)];
                            if (propertyInfo.dbValueTransformer) {
                                ((void (*)(id, SEL, id))(void *) objc_msgSend)(model, propertyInfo.setter,[propertyInfo.dbValueTransformer transformedValue:value]);
                                break;
                            }
                            switch (propertyInfo.encodingType) {
                                case OOEncodingTypeBool:
                                    ((void (*)(id, SEL, bool))(void *) objc_msgSend)(model, propertyInfo.setter,[value boolValue]);
                                    break;
                                case OOEncodingTypeInt8:
                                    ((void (*)(id, SEL, char))(void *) objc_msgSend)(model, propertyInfo.setter,(char)[value intValue]);
                                    break;
                                case OOEncodingTypeUInt8:
                                    ((void (*)(id, SEL, unsigned char))(void *) objc_msgSend)(model, propertyInfo.setter,(unsigned char)[value intValue]);
                                    break;
                                case OOEncodingTypeInt16:
                                    ((void (*)(id, SEL, short))(void *) objc_msgSend)(model, propertyInfo.setter,(short)[value intValue]);
                                    break;
                                case OOEncodingTypeUInt16:
                                    ((void (*)(id, SEL, unsigned short))(void *) objc_msgSend)(model, propertyInfo.setter,(unsigned short)[value intValue]);
                                    break;
                                case OOEncodingTypeInt32:
                                    ((void (*)(id, SEL, int))(void *) objc_msgSend)(model, propertyInfo.setter,[value intValue]);
                                    break;
                                case OOEncodingTypeUInt32:
                                    ((void (*)(id, SEL, unsigned int))(void *) objc_msgSend)(model, propertyInfo.setter,(unsigned int)[value longLongValue]);
                                    break;
                                case OOEncodingTypeInt64:
                                    ((void (*)(id, SEL, long long))(void *) objc_msgSend)(model, propertyInfo.setter,[value longLongValue]);
                                    break;
                                case OOEncodingTypeUInt64:
                                    ((void (*)(id, SEL, unsigned long long))(void *) objc_msgSend)(model, propertyInfo.setter,(unsigned long long)[value longLongValue]);
                                    break;
                                case OOEncodingTypeFloat:
                                    ((void (*)(id, SEL, float))(void *) objc_msgSend)(model, propertyInfo.setter,[value floatValue]);
                                    break;
                                case OOEncodingTypeDouble:
                                    ((void (*)(id, SEL, double))(void *) objc_msgSend)(model, propertyInfo.setter,(short)[value doubleValue]);
                                    break;
                                case OOEncodingTypeNSString:
                                    ((void (*)(id, SEL, NSString *))(void *) objc_msgSend)(model, propertyInfo.setter,value);
                                    break;
                                case OOEncodingTypeNSDate:
                                    ((void (*)(id, SEL, NSDate *))(void *) objc_msgSend)(model, propertyInfo.setter,[NSDate dateWithTimeIntervalSince1970:[value doubleValue]]);
                                    break;
                                case OOEncodingTypeNSNumber:
                                    ((void (*)(id, SEL, NSNumber*))(void *) objc_msgSend)(model, propertyInfo.setter,[NSNumber numberWithDouble:[value doubleValue]]);
                                    break;
                                case OOEncodingTypeNSURL:
                        ...
                        case SQLITE_BLOB:
                        {
                            ...
                            NSData * value = [NSData dataWithBytes:sqlite3_column_blob(stmt, index) length:bytes];
                            if (propertyInfo.dbValueTransformer) {
                                ((void (*)(id, SEL, id))(void *) objc_msgSend)(model, propertyInfo.setter,[propertyInfo.dbValueTransformer transformedValue:value]);
                                break;
                            }
                            switch (propertyInfo.encodingType) {
                                case OOEncodingTypeNSData:
                                    ((void (*)(id, SEL, NSData*))(void *) objc_msgSend)(model, propertyInfo.setter,value);
                                    break;
                                default:
                                    NSLog(@"unexpected db value---class:%@,property:%@",NSStringFromClass(propertyInfo.ownClassInfo.cls),propertyInfo.propertyKey);
                            ...
                            break;
                        default:
                            NSLog(@"unexpected db column type:%d---class:%@,property:%@",type,NSStringFromClass(propertyInfo.ownClassInfo.cls),propertyInfo.propertyKey);
                            break;
                    }
                }
            }];
        ...
        if(mt){
            [mt syncInMt:^(OOMapTable *mt) {
                ...
                [mtModel oo_mergeWithJsonDictionary:jsonDictionary];
            }];
        }else{
